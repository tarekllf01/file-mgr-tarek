...
return [
    ...
    'maxUploadFileSize' => env('maxUploadFiles')?env('maxUploadFiles'):null,
    ...
    'allowFileTypes' => env('allowFileTypes')?explode(',',env('allowFileTypes')):['png','jpg','jpeg','PNG','JPG','JPEG','txt','TEXT','docx','pdf','PDF','zip'],
